...
initial_distribution = tfp.distributions.Categorical(probs=[0.2, 0.8]) #fisrt day is 80% cold
transition_distribution = tfp.distributions.Categorical(probs=[[0.3, 0.7],
